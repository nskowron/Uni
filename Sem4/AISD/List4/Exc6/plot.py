...
def run_test(ops):
    ...
    proc = subprocess.Popen(
        ["make", "run"],  # lub ["./twoj_program"] jeśli nie używasz make
...
plot_metric(
    ...
    "Średnia liczba porównań w Splay",
...
plot_metric(
    ...
    "Maksymalna liczba porównań w Splay",
...
plot_metric(
    ...
    "Średnia liczba odwołań do wskaźników w Splay",
...
plot_metric(
    ...
    "Maksymalna liczba odwołań do wskaźników w Splay",
...
plot_metric(
    ...
    "Maksymalna wysokość drzewa Splay",
...
plot_metric(
    ...
    "Średnia liczba porównań w Splay (usuwanie)",
...
plot_metric(
    ...
    "Maksymalna liczba porównań w Splay (usuwanie)",
...
plot_metric(
    ...
    "Średnia liczba odwołań do wskaźników w Splay (usuwanie)",
...
plot_metric(
    ...
    "Maksymalna liczba odwołań do wskaźników w Splay (usuwanie)",
...
plot_metric(
    ...
    "Średnia wysokość drzewa Splay (usuwanie)",
...
plot_metric(
    ...
    "Maksymalna wysokość drzewa Splay (usuwanie)",
