...
plot_metric(
    ...
    "Maksymalna liczba porównań w RBT",
...
plot_metric(
    ...
    "Średnia liczba odwołań do wskaźników w RBT",
...
plot_metric(
    ...
    "Maksymalna liczba odwołań do wskaźników w RBT",
...
plot_metric(
    ...
    "Maksymalna wysokość drzewa RBT",
...
plot_metric(
    ...
    "Średnia liczba porównań w RBT (usuwanie)",
...
plot_metric(
    ...
    "Maksymalna liczba porównań w RBT (usuwanie)",
...
plot_metric(
    ...
    "Średnia liczba odwołań do wskaźników w RBT (usuwanie)",
...
plot_metric(
    ...
    "Maksymalna liczba odwołań do wskaźników w RBT (usuwanie)",
...
plot_metric(
    ...
    "Średnia wysokość drzewa RBT (usuwanie)",
...
plot_metric(
    ...
    "Maksymalna wysokość drzewa RBT (usuwanie)",
